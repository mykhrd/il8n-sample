<template>
    <div>
        <header class="Header">
            <div class="container">
                <h1 class="Header__Title">Sample</h1>
                <nav class="Header__Menu">
                    ...
                    <span v-if="$i18n.fallbackLocale === 'en'">
                        <nuxt-link class="Header__Link" v-if="$i18n.locale === 'en'" :to="`/ja` + $route.fullPath" active-class="none" exact>
                            {{ $t('links.japanese') }}
                        </nuxt-link>
